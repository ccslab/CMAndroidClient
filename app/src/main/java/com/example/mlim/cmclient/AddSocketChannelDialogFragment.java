...
public class AddSocketChannelDialogFragment extends DialogFragment {
    ...
    public interface AddSocketChannelDialogListener {
    ...
    AddSocketChannelDialogFragment.AddSocketChannelDialogListener m_listener;
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            m_listener = (AddSocketChannelDialogFragment.AddSocketChannelDialogListener) activity;
        ...
        builder.setView(m_view)
                ...
                .setPositiveButton(R.string.button_confirm, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        m_listener.onAddSocketChannelDialogConfirmClick(AddSocketChannelDialogFragment.this);
                    }
                })
                .setNegativeButton(R.string.button_cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        // Send the negative button event back to the host activity
                        m_listener.onAddSocketChannelDialogCancelClick(AddSocketChannelDialogFragment.this);
                    }
                });
