...
public class AddChannelDialogFragment extends DialogFragment {
    ...
    AddChannelDialogFragment.AddChannelDialogListener m_listener;
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            m_listener = (AddChannelDialogFragment.AddChannelDialogListener) activity;
        ...
        builder.setView(m_view)
                ...
                .setPositiveButton(R.string.button_confirm, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        m_listener.onAddChannelDialogConfirmClick(AddChannelDialogFragment.this);
                    }
                })
                .setNegativeButton(R.string.button_cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        // Send the negative button event back to the host activity
                        m_listener.onAddChannelDialogCancelClick(AddChannelDialogFragment.this);
                    }
                });
