...
public class JoinSessionDialogFragment extends DialogFragment {
    ...
    JoinSessionDialogFragment.JoinSessionDialogListener m_listener;
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            m_listener = (JoinSessionDialogFragment.JoinSessionDialogListener) activity;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        m_view = inflater.inflate(R.layout.dialog_join_session, null);
        ...
        builder.setView(m_view)
                ...
                .setPositiveButton(R.string.button_confirm, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        m_listener.onJoinSessionDialogConfirmClick(JoinSessionDialogFragment.this);
                    }
                })
                .setNegativeButton(R.string.button_cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        // Send the negative button event back to the host activity
                        m_listener.onJoinSessionDialogCancelClick(JoinSessionDialogFragment.this);
                    }
                });
